...
declare module 'astro:content' {
  ...
  data: InferEntrySchema<"commentary">;
...
"guidance": Record<string, {
  ...
  body: string;
  collection: "guidance";
  data: InferEntrySchema<"guidance">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
...
"scripture": Record<string, {
  id: string;
  render(): Render[".md"];
  slug: string;
  body: string;
  collection: "scripture";
  data: InferEntrySchema<"scripture">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
...
"synonyms": Record<string, {
  ...
  body: string;
  collection: "synonyms";
  data: InferEntrySchema<"synonyms">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
